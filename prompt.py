...
PROMPT={
     'Q1': ('Q: Do hamsters provide food for any animals?
...
a pear would float. So the answer is no. Read the given context, and choose the correct answer to the question from options A, B, or C. Respond with a single alphabet.\n'
                      'Context: {context}\n'
                     'Question: {question}\n'
                     '{Option1}\n{Option2}\n{Option3}\n'
                     'Answer:'),
